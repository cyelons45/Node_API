...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiY3llbG9uczQ1IiwiYSI6ImNrYjkzdmJmcTBhZ3EydG1kdXhtcTVoMWwifQ.NA8-GUwZDuINu0bJHeiNdw';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.default.post('http://127.0.0.1:4000/api/v1/users/login', {
              email: email,
              password: password
            });
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.prev = 1;
            _context2.next = 4;
            return _axios.default.get('http://127.0.0.1:4000/api/v1/users/logout');
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"stripePayment.js":[function(require,module,exports) {
"use strict";
...
var _stripePayment = require("./stripePayment");
...
var btnuserSettings = document.querySelector('.form-user-data');
var userSettings = document.querySelector('.form-user-password');
var buyTour = document.getElementById('book-tour');
...
if (btnuserSettings) {
  btnuserSettings.addEventListener('submit', function (e) {
    e.preventDefault();
    var form = new FormData();
    form.append('email', document.getElementById('email').value);
    form.append('name', document.getElementById('name').value);
    form.append('photo', document.getElementById('photo').files[0]);
    (0, _updateSettings.updateMe)(form, 'data');
  });
}
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 6;
              return (0, _updateSettings.updateMe)({
                password: password,
